...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("image_edit", "Creates an approved deterministic local PNG edit-preview artifact or an approved allowlisted provider-backed image edit artifact, including OpenAI-style multipart, Google Imagen edit, and Google Imagen upscale adapters.", "write", RiskLevel.HIGH, {"prompt": "string", "source_path": "string", "mask_path": "string", "provider_url": "string", "token_secret": "string", "provider_adapter": "string"}, {"asset_path": "string"}, implementation_status="allowlisted_live_or_local", approval_required=True, categories=("media",)),
