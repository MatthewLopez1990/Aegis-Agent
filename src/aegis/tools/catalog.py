...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("hosted_sandbox_exec", "Submits an approved command to a configured hosted sandbox backend.", "execute", RiskLevel.HIGH, {"backend": "string", "command": "string", "provider_url": "string"}, {"status": "string"}, implementation_status="backend_gate", approval_required=True, categories=("execution",)),
