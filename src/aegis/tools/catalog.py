...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("browser", "Dependency-light HTTP-content browser session with text/table extraction, sanitized rendered snapshots, and virtual interaction records.", "read/write", RiskLevel.HIGH, {"action": "string"}, {"result": "object"}, implementation_status="local_sandbox", approval_required=True, categories=("browser",)),
        ...
        ToolSpec("browser_click", "Records an approved virtual click selector, or follows an exact static anchor through the governed HTTP connector; it does not execute DOM events.", "write", RiskLevel.HIGH, {"selector": "string"}, {"status": "string"}, implementation_status="local_sandbox", approval_required=True, categories=("browser",)),
        ToolSpec("browser_fill", "Records approved form state and updates matching stored static input/textarea controls without page JavaScript, cookies, or live DOM events.", "write", RiskLevel.HIGH, {"fields": "array"}, {"status": "string"}, implementation_status="local_sandbox", approval_required=True, categories=("browser",)),
        ToolSpec("browser_submit", "Submits one approved static GET form through the governed HTTP connector without JavaScript, cookies, storage, or live DOM events.", "write", RiskLevel.HIGH, {"session_id": "string", "selector": "string"}, {"status": "string"}, implementation_status="local_sandbox", approval_required=True, categories=("browser",)),
