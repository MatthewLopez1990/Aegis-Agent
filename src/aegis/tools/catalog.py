...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("tts", "Creates an approved local WAV audio cue artifact or an approved allowlisted provider-backed audio artifact, including OpenAI-style TTS, ElevenLabs TTS, and ElevenLabs speech-to-speech adapters.", "write", RiskLevel.MEDIUM, {"text": "string", "audio_path": "string", "provider_url": "string", "token_secret": "string", "provider_adapter": "string"}, {"asset_path": "string"}, implementation_status="allowlisted_live_or_local", approval_required=True, categories=("voice",)),
