...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("voice_transcribe", "Transcribes local audio text fallbacks or an approved allowlisted provider-backed audio upload, including an OpenAI-style transcription adapter.", "read", RiskLevel.MEDIUM, {"audio_path": "string", "provider_url": "string", "token_secret": "string", "provider_adapter": "string"}, {"text": "string"}, implementation_status="allowlisted_live_or_local", categories=("voice",)),
