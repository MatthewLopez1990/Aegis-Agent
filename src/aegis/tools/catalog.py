...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("github_pr", "Reads GitHub pull requests and PR comments, turns review comments into governed autofix plans, and can post approved brokered-token comments or autofix responses when configured.", "read/write", RiskLevel.HIGH, {"operation": "string", "provider_url": "string"}, {"result": "object"}, implementation_status="allowlisted_live_read_write_or_mock_connector", approval_required=True, categories=("github",)),
