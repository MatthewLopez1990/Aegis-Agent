...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("tts", "Creates an approved local WAV audio cue artifact or an approved allowlisted provider-backed audio artifact.", "write", RiskLevel.MEDIUM, {"text": "string", "provider_url": "string", "token_secret": "string"}, {"asset_path": "string"}, implementation_status="allowlisted_live_or_local", approval_required=True, categories=("voice",)),
