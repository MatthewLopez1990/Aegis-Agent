...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    return (
        ...
        ToolSpec("image_generate", "Creates an approved deterministic local PNG preview artifact or an approved allowlisted provider-backed image artifact.", "write", RiskLevel.HIGH, {"prompt": "string", "provider_url": "string", "token_secret": "string"}, {"asset_path": "string"}, implementation_status="allowlisted_live_or_local", approval_required=True, categories=("media",)),
