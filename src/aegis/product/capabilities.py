    ...
    return [
        {
            ...
            "target_requirements": [
                ...
                "remote_control_relay_action_proxy",
            ],
        },
        {
            "platform": "OpenClaw",
        ...
        },
        {
            ...
            "live_gap": "Relayed remote-control action proxy, remote plugin bundle signing/auto-update, subagent runtime depth, PR provider-write autofix automation, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
                "remote_control_relay_action_proxy",
