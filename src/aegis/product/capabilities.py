...
def _competitive_targets() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "live_gap": "Remote plugin bundle auto-install/update, subagent runtime depth, PR local patch application from review comments, mobile push/cloud session directory, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
                "remote_plugin_bundle_auto_install_and_update",
