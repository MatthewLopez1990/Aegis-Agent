...
def _competitive_targets() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "live_gap": "Relayed remote-control action proxy, remote plugin bundle signing/auto-update, subagent runtime depth, PR automation, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
                "remote_control_relay_action_proxy",
