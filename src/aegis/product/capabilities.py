...
def _competitive_targets() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "live_gap": "Remote plugin bundle signing/auto-update, subagent runtime depth, PR provider-write autofix automation, mobile push/cloud session directory, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
                "remote_plugin_bundle_signing_and_auto_update",
                "subagent_runtime_depth",
                "pr_provider_write_autofix_workflows",
