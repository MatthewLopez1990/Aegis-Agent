    ...
    return [
        {
            ...
            "live_gap": "API-key-ready Hermes providers plus verified Codex/Claude/Qwen Code/Copilot CLI subscription, Google Vertex AI, AWS Bedrock, and Azure Foundry cloud-identity bridges are routable; remaining provider-native gaps are OAuth/manual account bridges such as Nous Portal OAuth.",
            "target_requirements": [
        ...
        },
        {
            ...
            "live_gap": "Remote plugin bundle signing/auto-update, subagent runtime depth, PR local patch application from review comments, mobile push/cloud session directory, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
                "remote_plugin_bundle_signing_and_auto_update",
                "subagent_runtime_depth",
                "pr_local_patch_application_workflows",
                "mobile_push_and_cloud_session_directory",
    ...
    return [
        {
            ...
            "next_steps": [
                ...
                "Use the verified Codex/Claude/Qwen Code/Copilot subscription, Google Vertex AI, AWS Bedrock, and Azure Foundry official CLI bridges where available; keep other subscription and provider-native flows as official handoffs until scoped bridges exist.",
...
def _model_auth_operator_checklist(model_auth_parity: dict[str, Any]) -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "detail": "Verified Codex/ChatGPT, Claude Code, Qwen Code, and Copilot CLI subscription login can invoke through isolated official CLI bridges without token import; remaining subscription providers stay on official handoff until scoped bridges exist.",
        },
        {
            ...
            "detail": "Google Vertex AI, AWS Bedrock, Azure Foundry, and Copilot have verified official CLI bridges; Nous Portal and other provider-native OAuth/device flows remain explicit local handoff targets until governed bridges exist.",
        },
        {
