...
def _live_gap_backlog(
    ...
    return [
        ...
        },
        {
            ...
            "detail": "Replace conservative local previews and virtual browser state only where real rendering or media execution can be sandboxed safely.",
            "sample_tools": facade_tools[:8],
            "next_steps": [
                "Introduce a sandboxed renderer or media worker with no ambient workspace access.",
                "Preserve taint labels and artifact hashes for rendered output.",
