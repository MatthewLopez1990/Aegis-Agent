...
def _competitive_targets() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "live_gap": "Outbound Remote Control relay, remote plugin bundle signing/auto-update, subagent runtime depth, PR automation, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
