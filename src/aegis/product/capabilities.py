    ...
    return [
        ...
        },
        {
            ...
            "covered": [
                ...
                "metadata-only plugin marketplace/update planning",
            ],
            ...
            "live_gap": "Outbound Remote Control relay, remote plugin marketplace download/install automation, subagent runtime depth, PR automation, and broader provider OAuth bridges remain tracked gaps instead of silent stubs.",
            "target_requirements": [
                "remote_control_outbound_relay",
                "remote_plugin_marketplace_download_install_automation",
