...
- Mobile push delivery and broad cloud relay delivery remain blocked until explicit relay transport, brokered relay auth, origin allowlists, revocation propagation, and redacted relay receipts cover end-to-end remote actions.
