...
- Native mobile push delivery and broad cloud relay delivery remain blocked until explicit push/gateway transport, brokered relay auth, origin allowlists, revocation propagation, durable delivery acknowledgement, and redacted relay receipts cover end-to-end remote actions.
