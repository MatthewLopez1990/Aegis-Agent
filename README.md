...
- Built-in governed tool catalog with 71 policy-visible tools covering browser, web, files, shell, memory, media, voice, subagent, research, and MCP capabilities.
