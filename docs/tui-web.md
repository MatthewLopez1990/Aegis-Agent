...
- `browser status|connect|disconnect|session|sessions|close [session_id]|navigate <url>|live-navigate <url>|live-screenshot|live-click <selector>|live-fill <fields-json>|live-submit [selector]`, `chrome`
