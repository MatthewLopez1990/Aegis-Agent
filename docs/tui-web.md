...
- `browser extract|inspect|dom [selector]|table [selector]|screenshot|render|click <selector> [--approval-id id]|fill <json> [--approval-id id]`
- `boards`
- `backends`, `sandbox`
