...
- `plugins list|install|enable|disable|remove|reload|marketplace|updates`, `plugin`, `reload`, `reload-plugins`, `reload-skills`
- `memory search <query>`
