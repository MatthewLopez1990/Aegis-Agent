...
- `plugins list|install|enable|disable|remove|reload|marketplace|updates|fetch-manifest`, `plugin`, `reload`, `reload-plugins`, `reload-skills`
- `memory search <query>`
