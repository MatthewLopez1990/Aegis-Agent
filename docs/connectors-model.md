...
- `github`: GitHub-style mock for repos, issues, pull requests, PR comments, PR autofix planning, and approved PR autofix responses, with optional approved brokered-token live issue/comment writes.
