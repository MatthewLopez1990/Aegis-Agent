...
- `github`: GitHub-style mock for repos, issues, pull requests, PR comments, and PR autofix planning, with optional approved brokered-token live issue/comment writes.
