...
class TuiTests(unittest.TestCase):
    ...
    def test_tui_completes_commands_and_common_subcommands(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("agents status|autonomy-preflight|autonomy-step|profiles|delegate|handoff|review-packet|verify-packet|model-review|run|run-batch", help_rendered)
