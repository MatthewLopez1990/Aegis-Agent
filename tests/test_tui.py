...
class TuiTests(unittest.TestCase):
    ...
    def test_tui_dashboard_and_capabilities_show_implementation_readiness(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("selector_mutation", rendered)
            self.assertIn("live_browser_download_upload_and_arbitrary_js_adapter", rendered)
    ...
    def test_tui_completes_commands_and_common_subcommands(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("agents status|autonomy-preflight|profiles|delegate|handoff|review-packet|verify-packet|run|run-batch", help_rendered)
    ...
    def test_tools_run_command_executes_and_preserves_approval_gate(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            with redirect_stdout(output):
                ...
                tui.onecmd("agents profile-create Researcher --tool web_search --max-tool-calls 4 --max-runtime-seconds 60")
