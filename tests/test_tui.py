...
class TuiTests(unittest.TestCase):
    ...
    def test_tui_completes_commands_and_common_subcommands(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("operate - start a governed task", slash_hint)
            self.assertIn("  /resume", slash_hint)
            self.assertIn("operate - task controls", slash_hint)
            ...
            self.assertIn("operate - start a governed task", slash_root_hint)
